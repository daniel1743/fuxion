...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fuxion focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer select-none active:scale-[0.97] hover:-translate-y-0.5",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        md: "h-11 min-h-11 rounded-xl px-5 text-sm gap-2",
        default: "h-11 min-h-11 rounded-xl px-5 text-sm gap-2",
