...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer select-none active:scale-[0.97]",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        sm: "h-9 min-h-[36px] rounded-xl px-3 text-sm gap-1.5",
        md: "h-11 min-h-[44px] rounded-xl px-5 text-sm gap-2",
        default: "h-11 min-h-[44px] rounded-xl px-5 text-sm gap-2",
        lg: "h-14 min-h-[50px] rounded-xl px-6 text-base gap-2",
        hero: "h-16 min-h-[56px] max-h-[64px] rounded-xl px-8 text-base gap-2.5",
