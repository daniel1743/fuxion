...
const FaqPage = () => {
  ...
  return (
    ...
    >
      ...
      {/* ── HERO ─────────────────────────────────────────────── */}
      <section className="hidden md:flex relative min-h-[50vh] items-center overflow-hidden pt-28 bg-gradient-to-br from-[#f0faf4] via-white to-[#e8f5e9] dark:from-surface-muted dark:via-[#111827] dark:to-[#1b1630]">
