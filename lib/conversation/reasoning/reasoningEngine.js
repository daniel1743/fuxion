...
export const generateReasonedContext = (profile) => {
  ...
  if (analysis.nextAction === 'offer_purchase_help') {
    lines.push('ACCION: El cliente esta listo para comprar. Ofrece ayuda con el proceso de compra.');
  } else if (analysis.nextAction === 'guide_to_purchase') {
    lines.push('ACCION: El cliente muestra interes de compra. Guialo suavemente hacia la compra.');
  } else {
    lines.push('ACCION: Continua asesorando. No vendas, solo ayuda.');
  }
